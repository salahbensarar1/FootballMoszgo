...
class FirebaseConfig {
  ...
  static Future<FirebaseApp> initializeFirebase() async {
    try {
      _logger.i('🔥 Initializing Firebase for ${Environment.environment} environment');
  ...
  static Future<void> logEvent({
    ...
    try {
      if (_analytics != null && (Environment.isProduction || Environment.isStaging)) {
  ...
  static Future<void> setUserProperties({
    ...
    try {
      ...
      if (_analytics != null) {
        ...
        if (organization != null) {
          await _analytics!.setUserProperty(name: 'organization', value: organization);
        }
      }
