...
class _PaymentMonthIndicatorState extends State<PaymentMonthIndicator>
  ...
  Map<String, Map<String, dynamic>> _processPaymentData(
    ...
    print('🔍 [PaymentMonthIndicator] Processing ${docs.length} payment documents');

    for (final doc in docs) {
      final data = doc.data() as Map<String, dynamic>;
      final monthKey = data['month'] as String? ?? doc.id.split('-').last;

      print('🔍 [PaymentMonthIndicator] Doc ID: ${doc.id}, Month: $monthKey, isPaid: ${data['isPaid']}, isActive: ${data['isActive']}');
    ...
    print('🔍 [PaymentMonthIndicator] Final payment data keys: ${paymentData.keys}');
    return paymentData;
  }
