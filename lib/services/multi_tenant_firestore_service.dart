...
class MultiTenantFirestoreService {
  ...
  static CollectionReference collection(String collectionName) {
    if (!OrganizationContext.isInitialized) {
      throw Exception(
          'Organization context not initialized. Call OrganizationContext.initialize() first.');
    }
  ...
  static Future<DocumentReference> createDocument(
    ...
    try {
      ...
      _logger.e('❌ Failed to create document in $collectionName',
  ...
  static Future<void> updateDocument(
    ...
    try {
      ...
      _logger.e('❌ Failed to update document in $collectionName/$documentId',
          error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  static Future<void> deleteDocument(
    ...
    try {
      ...
      _logger.e('❌ Failed to delete document in $collectionName/$documentId',
          error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  static Future<DocumentSnapshot> getDocument(
    ...
    try {
      ...
      _logger.e('❌ Failed to get document $collectionName/$documentId',
          error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  static Future<void> batchWrite(List<BatchOperation> operations) async {
    ...
    try {
      ...
      for (final operation in operations) {
        final docRef =
            collection(operation.collectionName).doc(operation.documentId);
        ...
        switch (operation.type) {
          ...
          case BatchOperationType.set:
            ...
            operation.data['organization_id'] =
                OrganizationContext.currentOrgId;
            batch.set(
                docRef, operation.data, SetOptions(merge: operation.merge));
            break;
